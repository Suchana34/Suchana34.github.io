...
const Projects = ({ offset, factor = 2 }: { offset: number; factor?: number }) => (
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      ...
      <cloud1Wide>
        <SVG icon="cloud2" hiddenMobile width={16} color="icon_green" left="20%" top="90%" />
        ...
        <SVG icon="cloud1" hiddenMobile width={8} color="icon_green" left="45%" top="10%" />
      </cloud1Wide>
      ...
      <SVG icon="planet" width={8} stroke color="icon_yellow" left="80%" top="70%" />
    </Divider>
  </div>
)
