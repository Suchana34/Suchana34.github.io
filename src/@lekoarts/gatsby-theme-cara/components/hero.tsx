...
const Hero = ({ offset, factor = 1 }: { offset: number; factor?: number }) => {
  ...
  return(
  <div>
    <div style={{marginLeft:2+'rem', marginBottom:0.3+'rem', marginTop:4+'rem'}}>
    <Morph width={1} stroke color="icon_orange" left="40%" top="0%" />
    </div>
    <Divider speed={0.2} offset={offset} factor={factor}>
      <UpDown>
        <SVG icon="cloud2" hiddenMobile width={48} stroke color="icon_orange" left="60%" top="10%" />
        <SVG icon="star" width={6} color="icon_darker" left="40%" top="5%" />
      </UpDown>
      <UpDownWide>
        ...
        <SVG icon="cloud1" hiddenMobile width={8} color="icon_darkest" left="75%" top="5%" />
      </UpDownWide>
      <SVG icon="cloud1" width={6} color="icon_darkest" left="4%" top="10%" />
      <SVG icon="cloud2" width={8} stroke color="icon_darker" left="25%" top="5%" />
      <SVG icon="star" hiddenMobile width={64} color="icon_purple" left="15%" top="90%" />
      ...
      <SVG icon="rocket" width={48} stroke color="icon_red" left="80%" top="7%" />
      <SVG icon="planet" width={30} stroke color="icon_darker" left="80%" top="70%" />
      <SVG icon="star" width={20} stroke color="icon_darker" left="80%" top="80%" />
